<div<?php print $attributes; ?>>
  <div<?php print $content_attributes; ?>>
    ...
    <div class="branding-data clearfix">
      ...
      <?php endif; ?>
      <?php $base_url = $GLOBALS['base_url']."/".$GLOBALS['theme_path']."/"; ?>
      <a href="<?php $GLOBALS['base_url']; ?>" id="tuLogoMobile" title="Temple University homepage"><img alt="Temple University logo" src="<?php print $base_url; ?>images/temple-university-logo.png" /></a>
